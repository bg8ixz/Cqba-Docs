...
categories:
  ...
  - 互联网语音
tags: []
lastUpdated: 2026-05-26T13:51:32.539Z
---
...
![D-STAR Gateway System 主页](/images/0204/D-Star_Register_Step1.jpeg)

同意协议，输入呼号、姓名、电子邮件地址和密码后，点击`OK`。

![D-STAR Gateway System 注册页](/images/0204/D-Star_Register_Step2.jpeg)
...
![D-STAR Gateway System 用户信息](/images/0204/D-Star_GW_Info.jpeg)

然后根据邮件中的说明进行设置。

![D-STAR Gateway System 用户信息](/images/0204/D-Star_GW_UserConfig.jpeg)
...
据测试，当前（2025年5月），Radio ID注册无需特殊上网方式。且BM服务器注册页面的人机验证也不再使用ReCAPTCHA。若此后情况有变化，可以更新该段。

因此请准备好**特定的**上网方式，或是按照[申请DMR ID到使用
...
![Radio ID 注册协议](/images/0204/RadioID_Register_Step1.jpeg)

2. 填写电子邮件和密码。

![Radio ID 邮箱和密码](/images/0204/RadioID_Register_Step2.jpeg)

3. 填写邮箱中收到的验证码。

![Radio ID 验证码](/images/0204/RadioID_Register_Step3.jpeg)

4. 输入呼号。

![Radio ID 输入呼号](/images/0204/RadioID_Register_Step4.jpeg)

5. 同意隐私保护协议，准备填写个人信息。这时候可能弹出一个对话框，点击`Close`关闭即可。然后同意条款进入下一步。

![Radio ID 同意协议](/images/0204/RadioID_Register_Step5.jpeg)

6. 在个人信息界面中填写自己的信息。

![Radio ID 个人信息](/images/0204/RadioID_Register_Step6.jpeg)

信息保存后会要求上传执照和操作证。

7. 首先按照以下示例照片的样子摆放执照和操作证并拍照。

![Radio ID 注册协议](/images/0204/RadioID_Register_Step8_ExamplePhoto.png)

（根据个人经验，身份证号可以打马赛克，不过可能要看审核员的心情）。

然后在个人信息页面中找到以下部分：

![Radio ID 注册协议](/images/0204/RadioID_Register_Step8.png)
...
![BrandMeister 注册](/images/0204/BrandMeister_Register.jpeg)
...
![BrandMeister主页](/images/0204/BrandMeister_Hotspot_Step1.jpeg)

2. 进入SelfCare界面后，不用管其他设置，直接修改热点密码即可。

![BrandMeister SelfCare](/images/0204/BrandMeister_Hotspot_Step2.jpeg)
...
![树莓派与热点板的选择](/images/0204/04_02_1_pi_select.png)
...
![烧录器下载页面](/images/0204/Rpi_Image_Download.jpeg)
...
![Pi-Star下载页面](/images/0204/Pi-Star_Download.jpeg)

![WPSD下载页面](/images/0204/WPSD_Download.jpeg)

下载好后将其解压缩，然后开始烧录镜像，先打开树莓派镜像烧录器，点左边第一个白色按钮，选择你的设备。

![烧录器](/images/0204/Rpi_Flash_Step1.png)

然后点击中间的按钮，选择刚才下载的镜像。

![选择镜像1](/images/0204/Rpi_Flash_Step2.png)
![选择镜像2](/images/0204/Rpi_Flash_Step3.png)

然后选择你刚插入的SD卡**千万别选错了**。

![选择储存卡](/images/0204/Rpi_Flash_Step4.png)

选好之后点下一步。这时会弹出对话框。

![不用自定义设置](/images/0204/Rpi_Flash_Step5.png)

然后确认烧录。

![确认烧录](/images/0204/Rpi_Flash_Step6.png)
...
![Pi-Star初始化](/images/0204/Pi-Star_Config1.png)

这时候通常会询问用户名和密码，默认的用户名是`pi-star`，默认的密码是`raspberry`。

然后进入配置页面，这里为了方便使用，首先将其修改为中文。
![Pi-Star英文配置](/images/0204/Pi-Star_Config2.jpg)
![Pi-Star中文配置](/images/0204/Pi-Star_Config.jpeg)
...
![配置MMDVM](/images/0204/Pi-Star_Config4.jpeg)
...
![配置MMDVM](/images/0204/Pi-Star_Config5.jpeg)

设置完成后，点击应用设置并等待重启。

最后，选择你想使用的模式，将其打开后应用设置。
![启用模式](/images/0204/Pi-Star_Config6.jpeg)
...
![系统融合](/images/0204/Pi-Star_YSF.jpeg)
...
![DMR](/images/0204/Pi-Star_DMR.jpeg)
