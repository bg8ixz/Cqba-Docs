...
lastUpdated: 2026-05-26T13:51:32.349Z
---
...
1. 访问[这里](https://ssl.qrz.com/support/new-account?op=newacct)，在页面下方输入你的呼号，点击`Continue`继续
   ...
   ![](/images/0204/01_05_1.png)

2. 输入你的电子邮件地址，点击`Continue`继续

   ![](/images/0204/01_05_2.png)
   
   附：呼号QQ邮箱的注册方式（被占用，或呼号中带QQ等特殊内容的无法注册，点名BH5UQQ🐮）

   ![](/images/0204/01_05_3.png)

3. 输入验证码，点击`Answer`提交答案

   ![](/images/0204/01_05_4.png)

4. 点击`Register`注册

   ![](/images/0204/01_05_5.png)

5. 前往邮箱，查看主题为`QRZ Account Verification`邮件，点击验证链接

   ![](/images/0204/01_05_6.png)

6. 在打开的网页中设置你的密码，点击`Submit`提交

   ![](/images/0204/01_05_7.png)

7. 注册完成

   ![](/images/0204/01_05_8.png)
...
<a href="https://rbn.telegraphy.de/activity/你的呼号">
    <images src="https://rbn.telegraphy.de/activity/image/你的呼号" />
</a>
```
