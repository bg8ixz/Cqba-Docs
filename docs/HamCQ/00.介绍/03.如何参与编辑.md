---
sidebarPrefix: icon-bianji-wenjian-bianji
title: 如何参与编辑
date: 2023-10-21 05:51:43
permalink: /pages/d99472/
categories:
  - HamCQ手册
  - 介绍
tags: []
lastUpdated: 2026-05-26T13:51:32.201Z
---
...
2. 您可以通过 **发表文章** 的方式，访问 ~~[forum.hamcq.cn](https://forum.hamcq.cn)~~(**网页端已关闭**)，完成账号注册，在`Wiki`节点，发表您的内容，请在文章或标题中体现您的文档合并意向，会有管理员与您进行对接。
...
手册图片请放置于项目 `docs/.vuepress/public/images` 中，请勿使用图床地址，避免图片断链丢失。  

**图片归类**：

图片请按照对应章节进行归类：例如，`什么是业余无线电`章节中的`一些故事`，归属 `0101` 归类，所属图片放置于 `/images/0101` 中。  
